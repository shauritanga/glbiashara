...
export function EditProfileForm({
  ...
  return (
    ...
    >
      ...
      >
        <span className="bg-gradient-to-r from-blue-600 to-indigo-600 h-8 w-1 rounded mr-3"></span>
        Edit Your Profile
      </h2>
      ...
      <div className="space-y-6 bg-gray-50 p-6 rounded-lg border border-gray-100">
        <h3 className="text-lg font-medium text-gray-900 flex items-center">
          <span className="bg-blue-500 h-5 w-5 rounded-full mr-2 flex items-center justify-center text-white text-xs">
            1
          </span>
          Personal Information
        </h3>
      ...
      <div className="space-y-6 bg-gray-50 p-6 rounded-lg border border-gray-100">
        <h3 className="text-lg font-medium text-gray-900 flex items-center">
          <span className="bg-indigo-500 h-5 w-5 rounded-full mr-2 flex items-center justify-center text-white text-xs">
            2
          </span>
          Address Information
        </h3>
      ...
      <div className="space-y-6 bg-gray-50 p-6 rounded-lg border border-gray-100">
        <h3 className="text-lg font-medium text-gray-900 flex items-center">
          <span className="bg-purple-500 h-5 w-5 rounded-full mr-2 flex items-center justify-center text-white text-xs">
            3
          </span>
          Professional Information
        </h3>
